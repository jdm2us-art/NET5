...
## На скриншоте по маршрутизаторам не видно тамблицу маршрутизации, прошу проверить настройки и дать обратную связь.

[net5.pkt](https://github.com/jdm2us-art/NET5/blob/main/net5.pkt)
